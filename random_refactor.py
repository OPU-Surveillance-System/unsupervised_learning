    ...
    for epoch in range(epochs):
        ...
        for p in phase:
            ...
            for i_batch, sample in enumerate(tqdm(dataloader)):
                ...
                z = sample_z(mu, var, inputs.size(0) * ((256 // patch_size)**2), z_dim)
                ...
                mu, var = encoder(inputs)
                z_fake = sample_z(mu, var, inputs.size(0) * ((256 // patch_size)**2), z_dim)
...
if __name__ == '__main__':
    ...
    #Models
    encoder = models.patch_random_adversarial_autoencoder.Encoder(args.f, args.l, args.b, args.z, args.p)
    encoder = encoder.cuda()
    decoder = models.patch_random_adversarial_autoencoder.Decoder(encoder.last_map_dim, args.l, args.b, args.z)
    decoder = decoder.cuda()
    discriminator = models.patch_random_adversarial_autoencoder.Discriminator(args.z, args.d)
